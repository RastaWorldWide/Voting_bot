...
async def start(message: types.Message):
    ...
    await message.answer(
        ...
        f"✨ <b>30 лет — Растем вместе!</b>\n"
        f"В честь юбилея мы запускаем номинацию <b>«Люди Роста»</b> —\n"
        f"чтобы отметить тех, кто вдохновляет, двигает вперёд и делает нашу компанию сильнее.\n\n"
